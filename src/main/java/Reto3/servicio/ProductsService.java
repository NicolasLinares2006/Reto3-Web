...
import Reto3.repositorio.ProductsRepositorio;
...
public class ProductsService {
     @Autowired
    private ProductsRepositorio clotheRepository;
   ...
   public Optional<Products> getClothe(String reference) {
    ...
    public Products update(Products accesory) {
        ...
        if (accesory.getReference() != null) {
            Optional<Products> accesoryDb = clotheRepository.getClothe(accesory.getReference());
